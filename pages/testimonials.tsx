        ...
        <article className={styles.testimonials}>
          <blockquote>
            ...
            <p>While I still have much work ahead of me, Jaymes' Mastermind group helped me get
              unstuck and take strides towards my goals...while increasing my capability.</p>
            <p>If you are feeling stuck, stalled or mired in your life, I heartily recommend
              Jaymes O'Pheron and his Mastermind groups.</p>
          ...
          <blockquote>
            <p>I have wanted this kind of thing for a long time, knowing that I needed significant
              ...
              held onto and put to use ideas that I get which I would forget before, I have felt more
              reason to do pretty much everything, I've come back to things that I initially didn't
              do soon enough, I have an "excuse" to make changes that might otherwise have seemed too
              "disruptive", and overall I have felt that I can see clearer.</p>
            <cite>Patrick L.</cite>
          </blockquote>
          <blockquote>
            <p>This mastermind was a great place to reflect on and refine my ideas and direction
              ...
              because he provides a fun environment to stretch yourself.</p>
          </blockquote>
          <blockquote>
          ...
          <blockquote>
            <p>Mastermind is a time of pushing my own development by facing my fears, growing
              ...
              in a thoughtful practical hour.</p>
              <cite>R. Zemek</cite>
          </blockquote>
          <blockquote>
            <p>This group was ably led and facilitated a depth of sharing that gave meaning to
              ...
              perspectives and shared them generously.</p>
          </blockquote>
          <blockquote>
            <p>Jaymes has tremendous facilitation skills, extending encouragement, relatability
              ...
              a supportive environment, then this masterclass is perfect.</p>
          </blockquote>
          <blockquote>
            <p>When I started these eight weeks I thought that I was doing it to help a friend,
              ...
              with Jaymes; it has changed my life and I think it could change yours too. </p>
              <cite>Sarah M.</cite>
          </blockquote>
          <blockquote>
